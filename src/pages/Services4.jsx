        ...
        <>
            ...
            <div className="aboutContentDiv py-9">
                <div className="aboutContentDivIn">
                    <h2 className="abouth2Size my-5">Tamper Proof Devices</h2>
                    <ul>
                        ...
                        <p className="my-5">Relevant: For bulk cargoes such as rice, fertilizer, sugar, wheat, cement, iron ores, gysum, etc.
                        </p>
                        ...
                        <li><span className="aboutTitleSpan">(iii) Cargo Inspection Services:</span> The superintendence of a cargo consignment involves the attendance on board the ship, the supervision of the discharge, loading, tally of deliveries, remarks of discrepancies, etc.This service is relevant for bulk and break bulk, large and cased consignment, loading and unloading e.t.c.
                        </li>
                        <p className="my-5">Relevant: Project imports, Iron Rods, Rice, Sugar etc.</p>
                        ...
                        <p className="my-5">Suitable For terminal operators, transporters, importers, banks/financial e.t.c</p>
                        ...
                        <p className="my-5">Relevancy: Any damage cargo and marine claim management.</p>
